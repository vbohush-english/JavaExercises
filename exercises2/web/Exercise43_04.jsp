...
<html>
    <head>
        ...
        <title>Exercise43_04</title>
    </head>
    <body>
    <center>
            <p>Taxable Income: <%= Double.parseDouble(request.getParameter("income")) %></p>
            <p>Filing Status: <%= Integer.parseInt(request.getParameter("status")) %></p>
            <p style="color:red">Tax: <%= computetax(Integer.parseInt(request.getParameter("status")), Double.parseDouble(request.getParameter("income"))) %></p>

...
public class Exercise14 extends JApplet {
	...
	public Exercise14() {
		...
		jspMonth.setValue(((SpinnerListModel) jspMonth.getModel()).getList().get(calendarPanel.getMonth()));
		spinnerYear.setValue(calendarPanel.getYear());	
	...
	public static void main(String[] args) {
		JFrame frame = new javax.swing.JFrame("Exercise14");

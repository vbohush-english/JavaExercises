...
public class Exercise04 {
    ...
    public static class RBTree<E extends Comparable<E>> extends BST<E> {
        ...
        public void displayPath() {
            displayPath((RBTreeNode<E>) root);
        }

        private void displayPath(RBTreeNode<E> node) {
            if(node == null) {
                return;
            }
            ArrayList<RBTreeNode<E>> list = getPath(node);
            for (RBTreeNode<E> treeNode : list) {
                System.out.print(treeNode.element + " ");
            }
            System.out.println();

            displayPath((RBTreeNode<E>) node.left);
            displayPath((RBTreeNode<E>) node.right);
        }
        
        public RBTreeNode<E> getParent(RBTreeNode<E> node) {
            return node.parent;
        }
        
        public ArrayList<RBTreeNode<E>> getPath(RBTreeNode<E> node) {
            ArrayList<RBTreeNode<E>> result = new ArrayList<>();
        ...
        private void updateParents() {
            ((RBTreeNode<E>) root).parent = null;
            updateParents((RBTreeNode<E>) root);
        }

        private void updateParents(RBTreeNode<E> root) {
            if (root == null) {
                return;
            }
            if(root.left != null) {
                ((RBTreeNode<E>)(root.left)).parent = root;
                updateParents((RBTreeNode<E>) root.left);
            }
            if(root.right != null) {
                ((RBTreeNode<E>)(root.right)).parent = root;
                updateParents((RBTreeNode<E>) root.right);
            }
        }        

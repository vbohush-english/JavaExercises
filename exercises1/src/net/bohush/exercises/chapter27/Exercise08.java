...
public class Exercise08 {
	...
	public static void main(String[] args) {
		...
		System.out.println();	
		for (ListIterator<Integer> iterator = tree.bidirectionaIterator(); iterator.hasPrevious();) {
	...
	static class BST<E extends Comparable<E>> extends AbstractTree<E> {
		...
		public java.util.ListIterator<E> bidirectionaIterator() {
		...
		private class BidirectionalIterator implements java.util.ListIterator<E> {
			...
			private int current = -2; // Point to the current element in list

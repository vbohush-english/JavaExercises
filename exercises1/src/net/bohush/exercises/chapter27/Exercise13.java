...
public class Exercise13 extends JPanel {
	...
	private JButton jbtShow1 = new JButton("Show Inorder");
	private JButton jbtShow2 = new JButton("Show Preorder");
	private JButton jbtShow3 = new JButton("Show Postorder");
	...
	static class DisplayBST extends JApplet {
		private static final long serialVersionUID = 1L;
		public DisplayBST() {
			add(new Exercise13(new BST<Integer>(new Integer[] {60, 55, 100, 45, 57, 67, 107, 101, 59})));
		}
	}

	/** Construct a view for a binary tree */
	public Exercise13(BST<Integer> tree) {
	...
	private void setUI() {
		...
		jbtShow1.addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				ArrayList<Integer> list = new ArrayList<>();
				list = tree.inorderList();
				String showString = "Inorder is ";
		...
		jbtShow2.addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				ArrayList<Integer> list = new ArrayList<>();
				list = tree.preorderList();
				String showString = "Preorder is ";
				for (Integer integer : list) {
					showString += integer + " ";
				}
				JOptionPane.showMessageDialog(null, showString);
		...
		jbtShow3.addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				ArrayList<Integer> list = new ArrayList<>();
				list = tree.postorderList();
				String showString = "Postorder is ";
				for (Integer integer : list) {
					showString += integer + " ";
				}
				JOptionPane.showMessageDialog(null, showString);

...
public class Exercise14 {
	...
	public static void main(String[] args) {
		BST<Integer> tree = new BST<>(new IntegerComparator(),  new Integer[] {60, 55, 100, 45, 57, 67, 107, 101, 59});
		tree.inorder();
	}
	...
	static class BST<E> extends AbstractTree<E> {
		...
		public BST(Comparator<? super E> comparator, E[] objects) {
			this(comparator);

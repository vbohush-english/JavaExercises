...
public class Exercise02 extends JApplet {
	...
	private JComboBox<String> jcboSelectionMode = new JComboBox<String>(new String[] {
	...
	private ActionListener deleteRows = new ActionListener() {
		@Override
	...
	private ActionListener deleteColumns = new ActionListener() {
		@Override
		public void actionPerformed(ActionEvent e) {
			int[] selectedColumns = jTable1.getSelectedColumns();
			for (int i = selectedColumns.length - 1; i >= 0; i--) {
				TableColumnModel columnModel = jTable1.getColumnModel();
				TableColumn tableColumn = columnModel.getColumn(selectedColumns[i]);
	...
	public Exercise02() {
		...
		jbtAddColumn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				tableModel.addColumn(name, new java.util.Vector<Object>());
			}
		});

		jbtDeleteRow.addActionListener(deleteRows);
		jbtDeleteColumn.addActionListener(deleteColumns);
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode() == KeyEvent.VK_DELETE) {
					if(jTable1.getColumnSelectionAllowed()) {
						deleteColumns.actionPerformed(null);
					}
					if(jTable1.getRowSelectionAllowed()) {
						deleteRows.actionPerformed(null);
					}
				}
			}
		});

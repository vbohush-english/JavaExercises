...
public class Exercise06 {
    ...
    static class Tree24<E extends Comparable<E>> implements Tree<E> {
        ...
        private void displayPath(Tree24Node<E> node) {
            ArrayList<Tree24Node<E>> list = getPath(node);
            for (Tree24Node<E> treeNode : list) {
                System.out.print("(");
                for (int i = 0; i < treeNode.elements.size(); i++) {
                    System.out.print(treeNode.elements.get(i) + " ");
                }
                System.out.print(") ");
            }
            System.out.println();
        ...
        public ArrayList<Tree24Node<E>> getPath(Tree24Node<E> node) {
            ArrayList<Tree24Node<E>> result = new ArrayList<>();
        ...
        private void updateParents(Tree24Node<E> root) {
            if (root == null) {
                return;
            }
            for (int i = 0; i < root.child.size(); i++) {
                root.child.get(i).parent = root;
                updateParents(root.child.get(i));
            }
        }
    ...
    // Split children for a non-leaf node
        ...
        protected static class Tree24Node<E extends Comparable<E>> {
            ...
            Tree24Node(E o, Tree24Node<E> parent) {
                elements.add(o);
                this.parent = parent;
            }
        }

...
public class Exercise03 extends JApplet {
	...
	public Exercise03() {
		...
		jspDate.addChangeListener(new ChangeListener() {			
			@Override
			public void stateChanged(ChangeEvent e) {
				GregorianCalendar calendar = new GregorianCalendar();
				calendar.setTime((Date) jspDate.getValue());
				int day = calendar.get(GregorianCalendar.DAY_OF_MONTH);
				int month = calendar.get(GregorianCalendar.MONTH);
				int year = calendar.get(GregorianCalendar.YEAR);
				jspDay.setValue(day);
				jspMonth.setValue(((SpinnerListModel) jspMonth.getModel()).getList().get(month));
	...
	public static void main(String[] args) {
		javax.swing.JFrame frame = new javax.swing.JFrame("Exercise03");

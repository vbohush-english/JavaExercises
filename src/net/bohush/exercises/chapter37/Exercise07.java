...
public class Exercise07 extends JApplet {
	...
	public void init() {
		...
		jTabbedPane.add(jPanel1, "Integer Operation");
		jTabbedPane.add(jPanel8, "Rational Operation");
		jTabbedPane.setToolTipTextAt(0, "Integer Operation");
		jTabbedPane.setToolTipTextAt(1, "Rational Operation");

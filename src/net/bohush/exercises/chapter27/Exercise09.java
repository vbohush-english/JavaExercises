...
public class Exercise09 {
	...
	public static void main(String[] args) {
		...
		BST<Integer> tree2 = (BST<Integer>) tree.clone();
		tree2.inorder();
	...
	static class BST<E extends Comparable<E>> extends AbstractTree<E> implements Cloneable {
		...
		protected Object clone() {
			...
			if(root != null) {
				newTree.root = new TreeNode<E>(root.element);
		...
		public void cloneNode(TreeNode<E> node1, TreeNode<E> node2) {
			if(node1.left != null) {
				node2.left = new TreeNode<E>(node1.left.element);
				cloneNode(node1.left, node2.left);
			}
			if(node1.right != null) {
				node2.right = new TreeNode<E>(node1.right.element);
				cloneNode(node1.right, node2.right);
			}
		}
		...
		public boolean equals(Object obj) {
			if (obj instanceof BST<?>) {
				@SuppressWarnings("unchecked")
				BST<E> tree2 = (BST<E>)(obj);
				if(size != tree2.size) {
					return false;
				} else {
					return isEqual(root, tree2.root);
				}
			} else {
				return false;
			}
		...
		private boolean isEqual(TreeNode<E> node1, TreeNode<E> node2) {

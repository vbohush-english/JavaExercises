...
public class Exercise03 {
	  ...
	  public static void main(String[] args) {
		...
		WeightedGraph<String>.ShortestPathTree tree11 = graph1.getShortestPath(graph1.getIndex("Chicago"));
		System.out.print("\n\n");
		tree11.printAllPaths();
		System.out.print("Shortest path from Houston to Chicago: ");
		java.util.List<String> path = tree11.getPath(11);
		for (String s : path) {
			System.out.print(s + " ");
		}
		
		WeightedGraph<String>.ShortestPathTree tree12 = graph1.getShortestPathByMatrix(graph1.getIndex("Chicago"));
		System.out.print("\n\n");
		tree12.printAllPaths();
		System.out.print("Shortest path from Houston to Chicago: ");
		path = tree12.getPath(11);
		for (String s : path) {
			System.out.print(s + " ");
		}
		...
		WeightedGraph<Integer>.ShortestPathTree tree21 = graph2.getShortestPath(3);
		System.out.print("\n\n");
		tree21.printAllPaths();
		
		WeightedGraph<Integer>.ShortestPathTree tree22 = graph2.getShortestPathByMatrix(3);
		System.out.print("\n\n");
		tree22.printAllPaths();
	}
